...
import { MenuKeyEnum, ToolsPathKeyEnum } from "@/constants/router"
import { useNavigate } from "react-router-dom"
const CompositionApiIntro = () => {
  const navigate = useNavigate()
  const start = () => {
    navigate(
      `/${MenuKeyEnum.Tools}/${ToolsPathKeyEnum.CompositionStyleConverter}`
    )
  }
  ...
  return (
    <div className={s.IntroContainer}>
      <div className={s.Intro}>
        ...
        <h3>一、简介</h3>
        <p>
          一个用于将 vue2-option-style 和 vue2-Decorate-style 转换为
          composition-api-style 的代码转换工具。
        </p>
        <h3>二、相关链接</h3>
        <p>
        ...
        <p>
          <a href="https://github.com/vuejs/composition-api">
            composition-api github 仓库
          </a>
        </p>
